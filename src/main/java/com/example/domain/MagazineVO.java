...
//	화면에서 type='file' name='file'이라서 변수명이 file
	...
	public void setFile2(MultipartFile file2) {
		...
		if(!file2.isEmpty()) {
			...
			//진짜 로컬에 파일이 저장되는 경로
			File f = new File("D:/springbootFinal/Feidear/src/main/resources/static/magazine_img_file/"+origin_file_name2);
			
			//우리가 jsp에서 불러와야 하는 파일 경로
			this.file_path2 = "/magazine_img_file/"+origin_file_name2;
			// 파일 저장 위치를 추후에 서버 경로를 얻어서 상대경로로 수정하기
			try {
