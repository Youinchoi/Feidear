												...
												<div class="menu_section">
													<ul class="nav side-menu">
														...
														<li><a href="manageQnA"><i
																	class="fa fa-question-circle"></i>문의사항
																관리</a></li>
														<li><a href="eventAdmin"><i
																	class="fa fa-calendar-check-o"></i>이벤트
																관리</a></li>
							...
							<div class="top_nav">
								<div class="nav_menu">
									<div class="nav toggle">
										<a id="menu_toggle" style="padding : 15px 15px 15px;"><i
											...
											<tbody>
												...
												<c:forEach items="${userList}" var="list">
													<tr class="even pointer">
														<td class=" ">${list.u_no}</td>
														<td class=" ">${list.u_id}</td>
														<td class=" ">${list.u_name}</td>
														<td class=" ">	
															<fmt:formatDate value="${list.u_date}" pattern="yyyy-MM-dd"/></td>
														<c:if test="${list.u_group eq 0}">
															<td class=" "><span class="badge badge-primary">일반
																	회원</span></td>
														</c:if>
														<c:if test="${list.u_group eq 1}">
															<td class=" "><span class="badge badge-warning">축제
																	관계자</span></td>
														</c:if>
														<td class=" "><span class="badge badge-secondary"
																onclick="location.href='/admin/updateUser?u_no=${list.u_no}'">보기</span>
													</tr>
												</c:forEach>
											</tbody>
										</table>
