    ...
    <div class="contact-area pd-top-108">
        <div class="container">
            <div class="row justify-content-center">
				...
				<div class="row">
					<div class="thumb">
						<img src="../images/others/damgom.jpg" alt="img">
					</div>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
					<div>
						<h2 class="title" style="color: darkorange;">정상적으로 로그아웃 되었습니다</h2><br>
						<h3>감사합니다!</h3><br><br>
						<h5 class="sign-in-btn" style="color:darkorange">홈으로 ☞<a href="/index">click!</a></h5>
					</div>
                </div>
            </div>
        </div>
