...
<body>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(images/destination-list/16.png);"></div>
                        <div class="details">
                            ...
                            <p class="location"><img src="images/icons/1.png" alt="map">Dubai</p>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(images/destination-list/11.png);"></div>
                        <div class="details">
                            <div class="tp-review-meta">
                                <i class="ic-yellow fa fa-star"></i>
                                <i class="ic-yellow fa fa-star"></i>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(images/destination-list/12.png);"></div>
                        <div class="details">
                            <div class="tp-review-meta">
                                <i class="ic-yellow fa fa-star"></i>
                                <i class="ic-yellow fa fa-star"></i>
                            ...
                            <p class="location"><img src="images/icons/1.png" alt="map">Italy</p>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(images/destination-list/5.png);"></div>
                        <div class="details">
                            <div class="tp-review-meta">
                                <i class="ic-yellow fa fa-star"></i>
                                <i class="ic-yellow fa fa-star"></i>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(images/destination-list/7.png);"></div>
                        <div class="details">
                            <div class="tp-review-meta">
                                <i class="ic-yellow fa fa-star"></i>
                                <i class="ic-yellow fa fa-star"></i>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(images/destination-list/9.png);"></div>
                        <div class="details">
                            <div class="tp-review-meta">
                                <i class="ic-yellow fa fa-star"></i>
                                <i class="ic-yellow fa fa-star"></i>
    ...
    <!-- footer area start -->
    <footer class="footer-area" style="background-image: urlimages/bg/2.png);">
        <div class="container">
            <div class="row">
