                ...
                <div class="col-xl-9 col-lg-8 order-lg-12">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single-destinations-list style-two">
                                <div class="thumb">
                                    <img src="<%=pjName%>/resources/assets/images/destination-list/8.png" alt="list">
                                </div>
                                <div class="details">
                                    <p class="location"><img src="<%=pjName%>/resources/assets/images/icons/1.png" alt="map">Africa</p>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single-destinations-list style-two">
                                <div class="thumb">
                                    <img src="<%=pjName%>/resources/assets/images/destination-list/9.png" alt="list">
                                </div>
                                <div class="details">
                                    <p class="location"><img src="<%=pjName%>/resources/assets/images/icons/1.png" alt="map">Thailand</p>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single-destinations-list style-two">
                                <div class="thumb">
                                    <img src="<%=pjName%>/resources/assets/images/destination-list/10.png" alt="list">
                                </div>
                                <div class="details">
                                    <p class="location"><img src="<%=pjName%>/resources/assets/images/icons/1.png" alt="map">Bali</p>
                                    <h4 class="title"><a href="tour-details">Bali Province</a></h4>
                                    <p class="content">3 days 2 person</p>
                                    <div class="tp-price-meta">
                                        <h2>620 <small>$</small></h2>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single-destinations-list style-two">
                                <div class="thumb">
                                    <img src="<%=pjName%>/resources/assets/images/destination-list/11.png" alt="list">
                                </div>
                                <div class="details">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="single-destinations-list style-two">
                                <div class="thumb">
                                    <img src="<%=pjName%>/resources/assets/images/destination-list/12.png" alt="list">
                                </div>
                                <div class="details">
                                    <p class="location"><img src="<%=pjName%>/resources/assets/images/icons/1.png" alt="map">Rome</p>
                ...
                <div class="col-xl-3 col-lg-4 order-lg-1">
                    <div class="sidebar-area sidebar-area-inner-page">
                        ...
                        <div class="widget_ads">
                            <a href="#"><img src="<%=pjName%>/resources/assets/images/others/01.png" alt="img"></a>
                        </div>
                    </div>
                </div>
            </div>
