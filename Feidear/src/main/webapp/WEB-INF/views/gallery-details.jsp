                    ...
                    <div class="gallery-filter-area row">
                        ...
                        <div class="tp-gallery-item col-md-4 col-12 mb-10">
                            <div class="tp-gallery-item-img">
                                <a class="popup-thumb" href="<%=pjName%>/resources/assets/images/gallery/1.png" data-effect="mfp-zoom-in">
                                    <img src="<%=pjName%>/resources/assets/images/gallery/1.png" alt="image">
                                </a>
                            </div>
                        </div>
                        <!-- gallery-item -->
                        <div class="tp-gallery-item col-md-4 col-12">
                            <div class="tp-gallery-item-img">
                                <a class="popup-thumb" href="<%=pjName%>/resources/assets/images/gallery/2.png" data-effect="mfp-zoom-in">
                                    <img src="<%=pjName%>/resources/assets/images/gallery/2.png" alt="image">
                                </a>
                            </div>
                        </div>
                        <!-- gallery-item -->
                        <div class="tp-gallery-item col-md-4 col-12">
                            <div class="tp-gallery-item-img">
                                <a class="popup-thumb" href="<%=pjName%>/resources/assets/images/gallery/3.png" data-effect="mfp-zoom-in">
                                    <img src="<%=pjName%>/resources/assets/images/gallery/3.png" alt="image">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="tp-gallery-item col-md-4 col-12">
                            <div class="tp-gallery-item-img">
                                <a class="popup-thumb" href="<%=pjName%>/resources/assets/images/gallery/4.png" data-effect="mfp-zoom-in">
                                    <img src="<%=pjName%>/resources/assets/images/gallery/4.png" alt="image">
                                </a>
                            </div>
                        </div>
                        <!-- gallery-item -->
                        ...
                        <div class="tp-gallery-item col-md-7 col-12">
                            <div class="tp-gallery-item-img">
                                <a class="popup-thumb" href="<%=pjName%>/resources/assets/images/gallery/6.png" data-effect="mfp-zoom-in">
                                    <img src="<%=pjName%>/resources/assets/images/gallery/6.png" alt="image">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="tp-gallery-item col-md-5 col-12">
                            <div class="tp-gallery-item-img">
                                <a class="popup-thumb" href="<%=pjName%>/resources/assets/images/gallery/7.png" data-effect="mfp-zoom-in">
                                    <img src="<%=pjName%>/resources/assets/images/gallery/7.png" alt="image">
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget widget">
                        ...
                        <ul class="widget-instagram-feed">
                            <li><a href="#"><img src="<%=pjName%>/resources/assets/imagesassets/img/instagram/1.png" alt="img"></a></li>
                            <li><a href="#"><img src="<%=pjName%>/resources/assets/imagesassets/img/instagram/2.png" alt="img"></a></li>
                            <li><a href="#"><img src="<%=pjName%>/resources/assets/imagesassets/img/instagram/3.png" alt="img"></a></li>
                            <li><a href="#"><img src="<%=pjName%>/resources/assets/imagesassets/img/instagram/4.png" alt="img"></a></li>
                            <li><a href="#"><img src="<%=pjName%>/resources/assets/imagesassets/img/instagram/5.png" alt="img"></a></li>
