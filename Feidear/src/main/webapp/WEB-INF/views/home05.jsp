...
<body>
        ...
        <div class="swiper-container banner-slider-two">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="banner-inner banner-inner-item-2" style="background-image: url(<%=pjName%>/resources/assets/images/banner/6.png);">
                        <p class="banner-cat s-animate-1">Hot Place</p>
                        <div class="title-and-video">
                            <h2 class="banner-title s-animate-2">Eiffel Tower</h2>
                            <div class="video-popup-wrap">
                                <div class="video-popup-btn s-animate-video style-two">
                                    <a href="https://www.youtube.com/watch?v=c7XEhXZ_rsk" class="video-play-btn mfp-iframe"><i class="fa fa-play"></i></a>
                                </div>
                            </div>
                        </div>
                        <p class="content s-animate-3">Navagio Beach, or Shipwreck Beach, is an exposed cove, sometimes referred to as.</p>
                        <a class="btn btn-yellow" href="tour-details">Book Now <i class="fa fa-paper-plane"></i></a>
                ...
                <!-- item -->
                <div class="swiper-slide">
                    <div class="banner-inner banner-inner-item-3" style="background-image: url(<%=pjName%>/resources/assets/images/banner/7.png);">
                        <p class="banner-cat s-animate-1">Travel</p>
                        <div class="title-and-video">
                            <h2 class="banner-title s-animate-2">Mykonos island</h2>
                            <div class="video-popup-wrap">
                                <div class="video-popup-btn s-animate-video style-two">
                                    <a href="https://www.youtube.com/watch?v=c7XEhXZ_rsk" class="video-play-btn mfp-iframe"><i class="fa fa-play"></i></a>
                                </div>
                ...
                <!-- item -->
                <div class="swiper-slide">
                    <div class="banner-inner" style="background-image: url(<%=pjName%>/resources/assets/images/banner/5.png);">
                        <p class="banner-cat s-animate-1">Discover</p>
                        <div class="title-and-video">
                            <h2 class="banner-title s-animate-2">Navagio Beach</h2>
                            <div class="video-popup-wrap">
                                <div class="video-popup-btn s-animate-video style-two">
                                    <a href="https://www.youtube.com/watch?v=c7XEhXZ_rsk" class="video-play-btn mfp-iframe"><i class="fa fa-play"></i></a>
                                </div>
    ...
    <div class="upcomming-world pd-top-108">
        ...
        <div class="upcomming-card-slider upcomming-card-slider-1 tp-common-slider-style">
            ...
            <div class="single-upconing-card">
                <div class="shadow" style="background-image: url(assets/img/tour/2.png);">
            ...
            <div class="single-upconing-card">
                <div class="shadow" style="background-image: url(assets/img/tour/3.png);">
            ...
            <div class="single-upconing-card">
                <div class="shadow" style="background-image: url(assets/img/tour/4.png);">
            ...
            <div class="single-upconing-card">
                <div class="shadow" style="background-image: url(assets/img/tour/5.png);">
            ...
            <div class="single-upconing-card">
                <div class="shadow" style="background-image: url(assets/img/tour/6.png);">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-blog">
                        ...
                        <div class="single-blog-details">
                            ...
                            <h4 class="title">Why You Shouldnât Ride Elephants France.</h4>
