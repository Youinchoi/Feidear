...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 offset-lg-2">
                    <div class="thumb about-section-right-thumb">
                        <img src="<%=pjName%>/resources/assets/images/others/9.png" alt="img">
                        <img class="about-absolute-thumb" src="<%=pjName%>/resources/assets/images/others/10.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-destination-grid style-two">
                        <div class="thumb">
                            <img src="<%=pjName%>/resources/assets/images/destination-list/17.png" alt="img">
                        </div>
                        <div class="details">
                            <ul class="d-list-meta">
                                <li class="date">2019</li>
                                <li><img src="<%=pjName%>/resources/assets/images/icons/13.png" alt="img"> 550+ Tour Complite</li>
                                <li><img src="<%=pjName%>/resources/assets/images/icons/14.png" alt="img"> 25+ Awards Win</li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-destination-grid style-two">
                        <div class="thumb">
                            <img src="<%=pjName%>/resources/assets/images/destination-list/18.png" alt="img">
                        </div>
                        <div class="details">
                            <ul class="d-list-meta">
                                <li class="date">2019</li>
                                <li><img src="<%=pjName%>/resources/assets/images/icons/13.png" alt="img"> 120+ Tour Complite</li>
                                <li><img src="<%=pjName%>/resources/assets/images/icons/14.png" alt="img"> 25+ Awards Win</li>
                            </ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-destination-grid style-two">
                        <div class="thumb">
                            <img src="<%=pjName%>/resources/assets/images/destination-list/19.png" alt="img">
                        </div>
                        <div class="details">
                            <ul class="d-list-meta">
                                <li class="date">2019</li>
                                <li><img src="<%=pjName%>/resources/assets/images/icons/13.png" alt="img"> 130+ Tour Complite</li>
                                <li><img src="<%=pjName%>/resources/assets/images/icons/14.png" alt="img"> 25+ Awards Win</li>
                            </ul>
    ...
    <div class="team-newslater-bg" style="background-image:url(<%=pjName%>/resources/assets/images/bg/4.png);">
        <!-- team area end -->
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team text-center">
                            <div class="thumb">
                                <img src="<%=pjName%>/resources/assets/images/team/1.png" alt="team">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team text-center">
                            <div class="thumb">
                                <img src="<%=pjName%>/resources/assets/images/team/2.png" alt="team">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team text-center">
                            <div class="thumb">
                                <img src="<%=pjName%>/resources/assets/images/team/3.png" alt="team">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-team text-center">
                            <div class="thumb">
                                <img src="<%=pjName%>/resources/assets/images/team/4.png" alt="team">
                            </div>
