            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(<%=pjName%>/resources/assets/images/destination-list/16.png);"></div>
                        <div class="details">
                            ...
                            <p class="location"><img src="<%=pjName%>/resources/assets/images/icons/1.png" alt="map">Dubai</p>
                            <h4 class="title"><a href="tour-details">Dubai City</a></h4>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(<%=pjName%>/resources/assets/images/destination-list/11.png);"></div>
                        <div class="details">
                            <div class="tp-review-meta">
                                <i class="ic-yellow fa fa-star"></i>
                                <i class="ic-yellow fa fa-star"></i>
                            ...
                            <p class="location"><img src="<%=pjName%>/resources/assets/images/icons/1.png" alt="map">France</p>
                            <h4 class="title"><a href="tour-details">Eiffel Tower</a></h4>
                            <p class="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat</p>
                            <div class="list-price-meta">
                                <ul class="tp-list-meta d-inline-block">
                                    <li><i class="fa fa-calendar-o"></i> 8oct</li>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(<%=pjName%>/resources/assets/images/destination-list/12.png);"></div>
                        <div class="details">
                            <div class="tp-review-meta">
                                <i class="ic-yellow fa fa-star"></i>
                                <i class="ic-yellow fa fa-star"></i>
                            ...
                            <p class="location"><img src="<%=pjName%>/resources/assets/images/icons/1.png" alt="map">Italy</p>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(<%=pjName%>/resources/assets/images/destination-list/5.png);"></div>
                        <div class="details">
                            <div class="tp-review-meta">
                                <i class="ic-yellow fa fa-star"></i>
                                <i class="ic-yellow fa fa-star"></i>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(<%=pjName%>/resources/assets/images/destination-list/7.png);"></div>
                        <div class="details">
                            <div class="tp-review-meta">
                                <i class="ic-yellow fa fa-star"></i>
                                <i class="ic-yellow fa fa-star"></i>
                ...
                <div class="col-lg-6">
                    <div class="single-destinations-list style-four">
                        <div class="blur-thumb" style="background-image:url(<%=pjName%>/resources/assets/images/destination-list/9.png);"></div>
                        <div class="details">
                            <div class="tp-review-meta">
                                <i class="ic-yellow fa fa-star"></i>
                                <i class="ic-yellow fa fa-star"></i>
