                    ...
                    <div class="tour-list-area">
                        <div class="single-destinations-list style-three">
                            ...
                            <div class="details">
                                ...
                                <p class="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et.</p>
                        ...
                        <div class="single-destinations-list style-three">
                            ...
                            <div class="details">
                                ...
                                <p class="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusa.</p>
                                <div class="list-price-meta">
                                    <ul class="tp-list-meta d-inline-block">
                                        <li><i class="fa fa-calendar-o"></i> 8oct</li>
                                        <li><i class="fa fa-clock-o"></i> 4 days</li>
                        ...
                        <div class="single-destinations-list style-three">
                            ...
                            <div class="details">
                                ...
                                <h4 class="title"><a href="tour-details">Cox's bazar Beach</a></h4>
                                <p class="content">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusa.</p>
                                <div class="list-price-meta">
                                    <ul class="tp-list-meta d-inline-block">
                                        <li><i class="fa fa-calendar-o"></i> 8oct</li>
